...
<head>
   ...
   if(elem.value == 1)
   {
	 ...
	 document.getElementById('modalPurchase').style.display = "block";
	 document.getElementById('modalProduct').false ;
	 document.getElementById('modalFree').false ;
   }
   else if(elem.value == 2)
   {	
		document.getElementById('modalProduct').style.display = "block"; 
		document.getElementById('modalPurchase').false;
		document.getElementById('modalFree').false ;
   }
	...
	<div class="header">
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				i								<li><a href="products5.html">Pet Food </a></li>
											</ul>
										</li>
										<li class="has-children">
				...
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> Latest Offers And Discount Are Available Here...... <span>Find The Best Shop Near You!!</span> <span> For The Best Choice , Make Your First Choice - ShopoviA</span></a></div>
	...
	<div id="modalPurchase" class="modal fade" role="dialog">
		...
		<div class="modal-content">
				...
				<div class="modal-body">
                                    <form action="purchaseprocess.php" method="post" enctype="multipart/form-data">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
				    ...
				    <button type="button" class="button" title="passport size photo" onclick="document.getElementById('upload').click();"><font color="white">Upload image</font></button>
                                    <div id="none">
                                    <input type="file"  id="upload" name="productimage" title="Product Image" required=""><br><br>
                                    </div>
					<br><br>
					 <input type="submit" id="form">
	...
	<div id="modalFree" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form action="buy_get.php" method="post" enctype="multipart/form-data">
					<input type="text" id="form"  name="product_name" placeholder="Name of Product" required=""><br><br>
					<input type="text" id="form" name="description"  placeholder="Description Of Your Product" required=""><br><br>
...
<div class="footer">
	...
	<div class="copy-right"> 
		<div class="container">
			<p>© 2017 Smart bazaar . All rights reserved | Design by ANKUSH , AVINASH & ABHIMANYU</p>
		</div>
	</div> 
	<!-- cart-js -->
