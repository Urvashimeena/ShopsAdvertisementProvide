		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				...
				<?php require './conn.php';
                                     ...
                                     if($search=='Shop_Name')
                                     {
                                           echo "<h1>"."Search By Shop Name"."</h1>";
                                     }
                                     else
                                     {
                                         echo "<h1>"."Search By Landmark"."</h1>";
				...
				<div class="products-row">
                                    <?php
                                       ...
                                       $search=$_GET["search"];
                                        ...
                                        $q= strtolower($str);
                                         if($search=='landmark')
                                          {
                                               $sql="SELECT * FROM shop WHERE LOWER(landmark) LIKE '%{$q}%'";
						     ...
						     <div class="agile-products" id="l">
                                                         <?php   echo '<a href="single.php?aa='.$shop_code.' && bb='.$name.'">'?>
                                                       	  <img src="<?php echo "uploadimages/".$name."/".$image;?>" id = "img" class="img-responsive" alt="img">
							    <?php echo '</a>'?>
								...
								<?php echo $shop_name; ?>
                                       ...
                                       else if($search=='Shop_Name')
                                          {
                                              $sql1="SELECT * FROM shop WHERE LOWER(shop_name) LIKE '%{$q}%' ";
                                              $result1= mysqli_query($conn, $sql1);
                                              
                                              while($row1= mysqli_fetch_assoc($result1))
                                              {
                                                  $image1=$row1["shop_image"];
                                                  $name1=$row1["shopkeeper_name"];
                                                  $shop_name1=$row1["shop_name"];
                                                  $shop_code=$row1["shop_code"];
                                                  ?>
                                          
                                                    <div class="col-md-3 product-grids"> 
						     <div class="agile-products"  id="l">
                                                          <?php   echo '<a href="single.php?aa='.$shop_code.' && bb='.$name1.'">'?>
                                                       	  <img src="<?php echo "uploadimages/".$name1."/".$image1;?>" id = "img" class="img-responsive" alt="img">
                                                           <?php echo '</a>'?>
							<div class="agile-product-text">      
                                                          <h5> 
                                                           <?php echo $shop_name1; ?>    
